...
Følgende hovedprinsipper ligger til grunn for (#kommende#) Los4.0:
...
. Los skal være *rent hierarkisk*. Dette betyr at hvert Los-tema skal bare finnes ett sted i Los-strukturen. Det er dessuten ikke en «type / subtype»-relasjon mellom nivåene i Los, men en «innholder / inngår i»-relasjon, selv om det i noen tilfeller vil kunne tolkes som en «type / subtype»-relasjon. 
...
. Los skal *ikke være en «ordbok»*. Dette betyr at Los4.0 ikke kommer til å inneholde forklaring på temaene, men skal peke til relevante begreper/forklaringer som er tilgjengelige i begrepskataloger, regelverk, veiledere osv. 
...
* *Hører til* som angier hvilket nivå i Los-strukturen temaet befinner seg på (f.eks. «Hjelpemiddel» hører til nivå 3).
