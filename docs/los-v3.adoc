...
Merk at oversettelser til andre målformer og språk ikke er komplette, og at det er mulig å bidra til flere oversettelser direkte i vokabularets kildekode på GitHub.
...
image::images/los-struktur3.png[align=center, alt="Tegning med 20 noder fordelt på 4 nivåer og linjer i mellom dem. Tegningen er forklart i teksten."]
