...
[cols="1,4"]
|===
h|Emneord|Et emneord er et uttrykk for innholdet i ressursen som skal beskrives.
h|Hjelpeord|Tilleggsord (synonymer, språkvarianter osv.) som skal hjelpe brukerne med å finne det rette emneordet.
h|Synonym|Gresk ord som betyr ”sammebetydning”. Det er altså ord som betyr det samme som emneordet.
h|SKOS|Simple Knowledge Organization System
||
|===
